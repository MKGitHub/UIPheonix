                                    ...
                                    UITableViewDataSource, UITableViewDelegate
{
    ...
    private func setupWithModels()
    {
        ...
        */
        ...
        let simpleUserProfileModel1 = SimpleUserProfileModel(title:"#1 The quick, brown fox.", description:"Tilde coloring book health goth echo park, gentrify semiotics vinyl cardigan quinoa meh master cleanse cray four dollar toast.")
